...
#folder = '/home/tiago/Data/isilon-science/PAG_project/raw_data/doric_scope/15OCT01/'
...
#print(doricFrameIndex, np.diff(doricFrameIndex))
...
xvector = np.copy(doricFrameIndex)
xvector = xvector[2:-1]   #doric drops 2 frames at the start and 1 at the end
